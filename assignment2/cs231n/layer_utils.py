...
def affine_batchnorm_relu_forward(x, W, b, gamma, beta, bn_param):
    """Convenience layer that performs an affine batchnorm transform followed by a ReLU.
    ...
    - cache: Object to give to the backward pass
    """  
    # Applying affine forward
    out, fc_cache = affine_forward(x, W, b)
    # Applying batchnorm forward
    out, batchnorm_cache = batchnorm_forward(out, gamma, beta, bn_param)
    # Applying relu forward 
    out, relu_cache = relu_forward(out)
    cache = (fc_cache, batchnorm_cache, relu_cache)
    return out, cache

def affine_batchnorm_relu_backward(dout, cache):
    """Convenience layer that performs backward pass .

    Inputs:
    - dout: gradient output
    - cache: Object to perform backward pass

    Returns :
    - gradients of loss with respect to x,w,b,gamma,beta
    """
...
def affine_layernorm_relu_forward(x, w, b, gamma, beta, ln_param):
    """Convenience layer that performs an affine layernorm transform followed by a ReLU.

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta ,ln_param: parameters for layernorm
...
def affine_layernorm_relu_backward(dout, cache):
    """Convenience layer that performs backward pass for layernorm.
